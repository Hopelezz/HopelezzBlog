...
/* empty css                    */import { $ as $$module4, a as $$Post } from './Post.c7850b96.mjs';
import 'html-escaper';
...
const $$BlogPost = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html${addAttribute(content.lang || "en", "lang")} class="astro-Z6MJ5JNR">
	<head>
		${renderComponent($$result, "Meta", $$MetaTags, { "title": title, "description": description, "permalink": permalink, "class": "astro-Z6MJ5JNR" })}
	${renderHead($$result)}</head>

	<body class="astro-Z6MJ5JNR">
		${renderComponent($$result, "Cursor", $$Cursor, { "class": "astro-Z6MJ5JNR" })}
		${renderComponent($$result, "Navbar", $$Navbar, { "class": "astro-Z6MJ5JNR" })}
		<div class="container astro-Z6MJ5JNR">
			<main class="body home_content astro-Z6MJ5JNR">
				<div class=" astro-Z6MJ5JNR">
					<div class=" astro-Z6MJ5JNR">
						${renderComponent($$result, "BlogPost", $$Post, { "title": title, "publishDate": publishDate, "writer": writer, "href": href, "img": img, "description": description, "alt": alt, "class": "astro-Z6MJ5JNR" }, { "default": () => renderTemplate`<p class="astro-Z6MJ5JNR">${minutesRead}</p>${renderSlot($$result, $$slots["default"])}` })}
					</div>
				</div>
			</main>
		</div>
	${renderComponent($$result, "Footer", $$Footer, { "class": "astro-Z6MJ5JNR" })}
