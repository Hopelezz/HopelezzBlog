...
const $$BookPost = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html${addAttribute(content.lang || "en", "lang")} class="astro-2I2MS4E5">
	<head>
		${renderComponent($$result, "Meta", $$MetaTags, { "title": title, "description": description, "permalink": permalink, "class": "astro-2I2MS4E5" })}
	${renderHead($$result)}</head>

	<body class="astro-2I2MS4E5">
		${renderComponent($$result, "Cursor", $$Cursor, { "class": "astro-2I2MS4E5" })}
		${renderComponent($$result, "Navbar", $$Navbar, { "class": "astro-2I2MS4E5" })}
		<div class=" astro-2I2MS4E5">
			<main class="body home_content astro-2I2MS4E5">
				<div class="container astro-2I2MS4E5">
					<div class=" astro-2I2MS4E5">
						${renderComponent($$result, "BlogPost", $$Post, { "title": title, "publishDate": publishDate, "writer": writer, "href": href, "img": img, "description": description, "alt": alt, "class": "astro-2I2MS4E5" }, { "default": () => renderTemplate`<p class="astro-2I2MS4E5">${minutesRead}</p>${renderSlot($$result, $$slots["default"])}` })}
					</div>
				</div>
			</main>
		</div>
	${renderComponent($$result, "Footer", $$Footer, { "class": "astro-2I2MS4E5" })}
